...
export interface AdapterInterface {
     ...
     */
    addSocket(appId: string, ws: WebSocket<any>): Promise<boolean>;
     ...
     */
    addToChannel(appId: string, channel: string, ws: WebSocket<any>): Promise<number>;
     ...
     */
    getSockets(appId: string, onlyLocal?: boolean): Promise<Map<string, WebSocket<any>>>;
     ...
     */
    getChannelSockets(appId: string, channel: string, onlyLocal?: boolean): Promise<Map<string, WebSocket<any>>>;
